...
export interface ApiFaqFaq extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::faq.faq'> &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    page: Schema.Attribute.String & Schema.Attribute.DefaultTo<'global'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiFormConfigFormConfig extends Struct.SingleTypeSchema {
  ...
  attributes: {
    budgetOptions: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiGlobalSeoGlobalSeo extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    siteUrl: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'https://vyntechsolutions.ca'>;
...
export interface ApiNavigationNavigation extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footerGroups: Schema.Attribute.Component<'shared.link-group', true>;
    ...
    > &
      Schema.Attribute.Private;
    primaryLinks: Schema.Attribute.Component<'shared.nav-link', true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiOrganizationProfileOrganizationProfile
  ...
  attributes: {
    ...
    geoLatitude: Schema.Attribute.String;
    geoLongitude: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiPromoPromo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    slot: Schema.Attribute.Enumeration<
      ['announcement-bar', 'google-ranking', 'timed-cta', 'services-promo']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
