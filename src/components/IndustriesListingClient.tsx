...
type ListingIndustry = ListingIndustryCard;
...
export default function IndustriesListingClient({
  initialList,
  initialChrome,
  initialNavChrome,
}: {
  initialList: ListingIndustry[];
  initialChrome: IndustriesListingDefaults;
  initialNavChrome?: typeof DEFAULT_NAV_CHROME;
}) {
  const [isVisible, setIsVisible] = useState(false);
  const [list] = useState<ListingIndustry[]>(initialList);
  const [chrome] = useState<IndustriesListingDefaults>(initialChrome);
